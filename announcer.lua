...
local function on_paint(text)
    if data.anim.should_announce then
        ...
        render.text(fnt.font, text, vec2_t(scrn_size.x * 0.5, scrn_size.y * 0.4),  color_t(fnt.color[col_idx].r,fnt.color[col_idx].r,fnt.color[col_idx].r, math.floor(alpha+0.5)))
